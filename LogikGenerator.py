...
## LogikGenerator
## -----------------------------------------------------
## Copyright © 2010-2014, knx-user-forum e.V, All rights reserved.
##
...
5000|"'''+LOGIKCAT+'''\\'''+LOGIKNAME+'''_'''+VERSION+'''"|0|1|"E1 Wert"|1|"A1 Text"

5001|1|1|0|1|1

# EN[x]
5002|1|""|1 #* TestWert @@werteingabe

# Speicher
5003|1||0  #* Klassenspeicher @@irgendNeKlasse


# Ausgänge
5004|1|""|0|1|1 #* Text @@Logtext
...
"""])
## Es können beliebig viele dieser Codeblöcke angelegt werden
code.append([0,"EI","""
if EI==1:
    ## Beschreiben der Ausgänge
    
    ## Entspricht AN[1] (symbolize)
    @@Logtext='TEST"
    ## Entspricht AC[1] (symbolize Logtext + C)
    @@LogtextC=1
"""])
...
## Klasse auf SN1 
5012|0|"EI"|"irgendeineKlasse(EN[1])"|""|0|0|1|0


## Wenn sich EIngang 1 (über symbolize mit Namen werteingabe versehen) ändert  in der Klasse self.wert + das return gibt den Wert dort zurück und schreibt ihn dann auf Ausgang 1
# Entspricht 5012|0|"EC[1]"|"SN[1].machwas(EN[1])"|""|1|0|0|0
5012|0|"EC[1]"|"@@irgendNeKlasse.machwas(@@werteingabe)"|""|1|0|0|0
